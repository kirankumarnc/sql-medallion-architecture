/*
    ...
    Purpose:
        ...
        Run this script to create 'silver' tables based on
        the cleansed and standardised Bronze layer structure.

    Schema:   silver
    Source:   bronze
    Tables:   6 (3 CRM + 3 ERP)
*/

USE DataWarehouse;  -- Ensure script runs against the correct target database
